...
import eu.cdevreeze.tqa2.docbuilder.jvm.CachingThreadsafeDocumentBuilder.LoadingCacheWrapper
import eu.cdevreeze.yaidom2.queryapi.BackingDocumentApi

/**
 * Thread-safe DocumentBuilder using a Caffeine document cache. By all means, reuse the underlying document cache
 * as much as possible.
 *
