...
package eu.cdevreeze.tqa2.internal.standardtaxonomy.taxonomy.builder.jvm
...
import eu.cdevreeze.tqa2.internal.standardtaxonomy.taxonomy.builder.DtsUriCollector
...
/**
 * Default parallel DTS URI collector, for 'standard' taxonomies. JVM-only.
 *
 * @author Chris de Vreeze
 */
trait DefaultParallelDtsUriCollector extends DtsUriCollector {
  ...
  private def findDts(
    ...
    val taxoDocElemsToProcess: Seq[TaxonomyElem] = docUrisToProcess.toIndexedSeq.par.map(uri => taxoElemBuilder(uri)).seq
...
object DefaultParallelDtsUriCollector {

  final object DefaultInstance extends DefaultParallelDtsUriCollector

  final object InstanceAddingLocfreeSchemas extends DefaultParallelDtsUriCollector {
   ...
   */
  val instance: DefaultParallelDtsUriCollector = DefaultInstance

  /**
   * Returns InstanceAddingLocfreeSchemas
   */
  val instanceAddingLocfreeSchemas: DefaultParallelDtsUriCollector = InstanceAddingLocfreeSchemas
}
