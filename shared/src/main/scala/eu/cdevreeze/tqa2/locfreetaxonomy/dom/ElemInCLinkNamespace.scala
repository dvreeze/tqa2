 ...
 */
trait ElemInCLinkNamespace extends BackingElemApi {
  // TODO
}

object ElemInCLinkNamespace {

  // Linkbase

  trait Linkbase extends ElemInCLinkNamespace {
    // TODO
  }

  // Standard extended links

  trait StandardLink extends ElemInCLinkNamespace with locfreexlink.ExtendedLink {
    // TODO
  }
  ...
  trait StandardArc extends ElemInCLinkNamespace with locfreexlink.XLinkArc {
    // TODO
  }
  ...
  trait StandardResource extends ElemInCLinkNamespace with locfreexlink.XLinkResource {
    // TODO
  }
